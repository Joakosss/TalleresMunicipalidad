"""
Django settings for talleresMunicipales project.
...
SECRET_KEY = 'django-insecure-kvut^&dfmei!^_qoe+9zid#o(hraikut(yc^52cpv^(=gn9^ot'
...
ROOT_URLCONF = 'talleresMunicipales.urls'
...
WSGI_APPLICATION = 'talleresMunicipales.wsgi.application'
...
MESSAGE_TAGS = {
    message_constants.DEBUG: 'question',
